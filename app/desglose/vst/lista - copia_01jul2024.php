					...
					<tr>
						...
						<td width="10%">
							<div class="btn-group">
								...
								<!--</button>
								<button class="btn btn-info btn-xs" title="vernotas.php Ver Notas para este desglose" onclick="load('vst-desglose-lista_notas','ide=<?php //echo $r->desglose_ide ?>','.notas')">
