		...
		<fieldset><legend>Datos Personales del Cliente</legend>	
			...
			<div class="form-actions">
				<div class="btn-group pull-right">
					...
					<button type="button" class="btn btn-danger btn-sm pull-right" onclick="load('vst-compra-datos.personales','clien_ide=<?php echo $clien_ide ?>','.perfil')"><span class="i fa fa-times"></span> Cancelar</button>
				</div>
			</div>
		</fieldset>
	...
	$(function(){
		...
		$(formulario).validate({
			...
			submitHandler: function (form) {
				$.post('prc-ccompra-cupdatecli',$(formulario).serialize(),function(data){
					if(!isNaN(data)) {
						alert('Cambios guardados correctamente');
						load('vst-compra-datos.personales','clien_ide=<?php echo $clien_ide ?>','.perfil');
					} else {
