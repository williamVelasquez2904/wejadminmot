...
<?php foreach($musuarios->poride($s_usua_ide) as $r): ?>
	<form action="" class="op2-pac well">
		...
		<fieldset><legend>Datos Personales (Actualización de mi Cuenta)</legend>	
			...
			<div class="form-group col-sm-3">
				...
				<input type="hidden" name="tipo" value="<?php echo $r->usua_tius ?>">
				<input type="hidden" name="tie" value="<?php echo $r->usua_tienda ?>">
			</div>
