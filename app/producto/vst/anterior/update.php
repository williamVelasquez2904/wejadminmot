	...
	<form action="" class="op2-pac well">
		...
		<fieldset><legend>Datos del Producto o Servicio</legend>	
			<div class="form-group col-sm-3">
				<label for="" class="label control-label col-sm-12 bolder">ID:</label>
				<div class="col-sm-12">
					<input type="text" name="ide1" readonly="true" class="form-control" value="<?php echo $r->produc_ide ?>">
				</div>
			</div>
			<div class="form-group col-sm-3">
			...
			<div class="form-group col-sm-3">
				...
				<div class="col-sm-12">
					<input type="text" name="pre3" class="form-control" value="<?php echo $r->produc_precio3 ?>">
				</div>
			</div>
			<div class="form-group col-sm-3">
				<label for="" class="label control-label col-sm-12 bolder">Precio de Venta 4:</label>
				<div class="col-sm-12">
					<input type="text" name="pre4" class="form-control" value="<?php echo $r->produc_precio4 ?>">
				</div>
			</div>
			...
			<div class="form-group col-sm-3">
				...
				<div class="col-sm-12">
					<input type="text" name="col" class="form-control" value="<?php echo $r->produc_color ?>">
				</div>
			</div>
			<div class="form-group col-sm-3">
				<label for="" class="label control-label col-sm-12 bolder">Talla:</label>
				<div class="col-sm-12">
					<input type="text" name="tal" class="form-control" value="<?php echo $r->produc_talla ?>">
				</div>
			</div>
			<div class="form-group col-sm-3">
				<label for="" class="label control-label col-sm-12 bolder">Unidad de Medida:</label>
				<div class="col-sm-10" id="unidmed">
					<select class="form-control chosen" title="Agregar" name="unm" id="unm" onchange="load('vst-unidmed-select','unidmed_ide='+this.value,'#ideunm');">
						<option value=""></option>
			...
			<div class="form-group col-sm-3">
				...
				<div class="col-sm-12">
					<input type="text" name="med" class="form-control" value="<?php echo $r->produc_unidmed ?>">
				</div>
			</div>
			...
			<div class="form-group col-sm-3">
				...
				<div class="col-sm-10" id="marca">
					<select class="form-control chosen" title="Agregar" name="mar" id="mar" onchange="load('vst-marca-select','marca_ide='+this.value,'#idemar');">
						<option value=""></option>
			...
			<div class="form-group col-sm-3">
				...
				<div class="col-sm-10" id="modelo">
					<select class="form-control chosen" title="Agregar" name="mod" id="mod" onchange="load('vst-modelo-select','modelo_ide='+this.value,'#idemod');">
						<option value=""></option>
						<?php foreach($mmodelo->lista() as $p): ?>
							<option value="<?php echo $p->modelo_ide ?>" <?php echo $fn->select($p->modelo_ide,$r->produc_modelo) ?>><?php echo $p->modelo_descrip ?></option>
						<?php endforeach; ?>
					</select>
				</div>
			</div>
			<div class="form-group col-sm-3">
				...
				<div class="col-sm-10" id="impuesto">
					<select class="form-control chosen" title="Agregar" name="imp" id="imp" onchange="load('vst-impuesto-select','impuesto_ide='+this.value,'#ideimp');">
						<option value=""></option>
