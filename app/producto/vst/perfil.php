...
?>
<div class="btn-group navegacion-producto-fijo">
...
<script>
	<?php foreach($row_permisos as $rp): ?>
		load('<?php echo $rp->fich_url; ?>','produc_ide=<?php echo $produc_ide ?>&fich_ide=<?php echo $rp->fich_ide ?>','#ficha-<?php echo $rp->fich_ide; ?>');
	<?php endforeach; ?>
	
	$(function(){
		$('[data-rel=tooltip]').tooltip();
		$('.navegacion-producto-fijo>.ficha-open').on('click',function(){
