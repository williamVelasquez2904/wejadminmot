...
<form action="" class="op1">
	...
	<fieldset><legend>Datos de la Compra</legend>	
		...
		<div class="form-group col-sm-3 col-xs-12">
			...
			<div class="col-sm-12 col-xs-12">
				<select class="form-control chosen" name="destino" id="destino" onchange="habilitar_flete(this)">
		...
		<div class="form-group col-sm-4 col-xs-12">
			...
			<div class="col-sm-12 col-xs-12">
				<select class="form-control chosen" title="Proveedor" name="prov_ide" id="prov_ide"  onchange="habilitar_tasa(this)">
					<option value=""></option>
		...
		<input type="text" class="form-control" name="prov_name" id="prov_name" value="<?php echo $p->prove_razonsocial; ?>">	
...
<script>
	...
	function habilitar_tasa(obj) {
	 	var hab;
	  	frm=obj.form;
	  	num=obj.selectedIndex;
	  	if (num==1) hab=true;
	  	else if (num==2) hab=false;
	  	frm.tasa.disabled=hab;
	  	frm.mto_subtotal.disabled=hab;
	}

	function habilitar_flete(obj) {
	 	var hab;
	  	frm=obj.form;
	  	num=obj.selectedIndex;
	  	if (num==1) hab=true;
	  	else if (num==2) hab=false;
	  	frm.porc_flete.disabled=hab;
	  	/*frm.mto_flete.disabled=hab;*/
	  	frm.mto_flete.value=0;
		...
		$(formulario).validate({
			...
			submitHandler: function (form) {
				...
				if (f_porc.trim().length===0){
					if (f_porc <> 2){
						alert('Debe Seleccionar porcentaje');
						$flag=false;
					}
				}				
