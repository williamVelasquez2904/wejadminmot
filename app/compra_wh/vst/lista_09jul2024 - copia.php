			...
			<tbody>
				<?php foreach($row as $r): 
					...
					<tr  bgcolor="<?php echo $color_fondo; ?>" style="color: <?php echo $color_letra;  ?>;">
						<td style="<?php echo $estilo; ?>"><?php echo $r->compra_ide ?></td>
						<td style="<?php echo $estilo; ?>" align="center"><?php echo $r->compra_fecha ?></td>
						<td style="<?php echo $estilo; ?>" align="left" ><?php echo $r->nombre1.$texto_destino ?></td>
