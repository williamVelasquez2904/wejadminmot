...
$row = $morden->listaporprov($prove_ide) ?>
<?php if(count($row)>0): ?>
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				<?php foreach($row as $r): ?>
					<tr>
						<td align="center"><?php echo $r->orden_ide ?></td>
						<td><?php echo $r->prove_razonsocial ?></td>
						<td><?php echo $r->orden_control ?></td>
						<td><?php echo $r->orden_monto ?></td>
						<td><?php echo $r->orden_fecha ?></td>
						<td>
							<div class="btn-group">
