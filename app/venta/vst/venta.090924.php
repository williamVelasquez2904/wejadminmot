...
$titulo="[venta/venta.php] (09-09-2024) PROCESAR VENTA. $ide --- ORIGEN: $text_origen ";
...
<!-- 
 		<div class="form-group col-sm-2 col-xs-12">
			...
			<div class="col-sm-12 col-xs-12">
				<input type="text" class="form-control" name="f_compra_tipo" id ="f_compra_tipo" value="<?php //echo $r->tipvta_descrip ?>" disabled>
			</div>
		</div>
		<input type="hidden" class="form-control" name="tipo" id ="tipo" value="<?php //echo $r->f_compra_tipo ?>">
 -->
