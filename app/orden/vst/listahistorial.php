...
$row = $morden->listaporestatus(1,2); 
if(count($row)>0):?>
			...
			<tbody>
				<?php foreach($row as $r):
					...
					<tr bgcolor="<?php echo $color ?>">
						...
						<td align="center">
							<div class="btn-group">
								<button class="btn btn-info btn-xs" title="Ver Detalles" onclick="modal('vst-orden-verdetalleshistorial','ide=<?php echo $r->orden_ide ?>')">
